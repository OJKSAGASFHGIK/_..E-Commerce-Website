      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mt-0">
            ...
            <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-1 md:mt-0 relative ">
              <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Shipping Address</h2>
              {/* <p className="leading-relaxed mb-5 text-gray-600">Post-ironic portland shabby chic echo park, banjo fashion axe</p> */}
              <div className="relative mb-1">
                <label for="address" className="leading-1 text-sm text-gray-800">Address</label>
              ...
              <div className="relative mb-1">
                <label for="city" className="leading-1 text-sm text-gray-800">City</label>
              ...
              <div className="relative mb-1">
                <label for="postalcode" className="leading-1 text-sm text-gray-800">Postal Code</label>
              ...
              <div className="relative mb-3">
                <label for="country" className="leading-1 text-sm text-gray-800">Country</label>
