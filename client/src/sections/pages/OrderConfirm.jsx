...
import { orderDetailAction } from './../../redux/actions/Order.js';
      ...
      {loading ? (
        ...
        <div className="flex items-center justify-center min-h-screen bg-white">
          ...
          <div className="p-8 bg-gray-100 rounded-lg shadow-lg text-center">
            ...
            <button
              className="cursor-pointer px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition duration-200"
              onClick={() => {
