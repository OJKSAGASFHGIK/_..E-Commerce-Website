...
import OrderConfirm from './sections/pages/OrderConfirm.jsx';
import OrderHistory from './sections/pages/OrderHistory.jsx';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route exact path="/order/:id" element={<OrderConfirm/>} />
